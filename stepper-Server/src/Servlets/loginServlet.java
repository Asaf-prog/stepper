...
public class loginServlet extends HttpServlet {
    ...
    // Each method with its pros and cons...
            ...
            if (usernameFromParameter == null || usernameFromParameter.isEmpty()) {
                ...
                synchronized (this) {
                    if (userManager.isUserExists(usernameFromParameter)) {
                        ...
                        request.setAttribute(Constants.Constants.USER_NAME_ERROR, errorMessage);
                        ...
                        //create a new one
                        request.getSession(true).setAttribute(Constants.Constants.USERNAME, usernameFromParameter);
